...
**GET http://localhost:8080/api/courses** — Возвращает все курсы

**GET http://localhost:8080/api/courses/5** — Возвращает один курс по ID.

**POST http://localhost:8080/api/courses** — Создает новый курс.  
*Тело запроса:*
```json
{
